...
import { cpSync, rmSync, existsSync, mkdirSync, watch, readFileSync, writeFileSync, readdirSync } from 'node:fs';
...
// Default to production mode if NODE_ENV is not explicitly set to 'development'
